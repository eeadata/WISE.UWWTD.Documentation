...
ART --- N3((NO)) --- N111["Article 5(4)+5(2,3) applies"]
...
N2_node --- N13((NO)) --- N3_node["If receiving area demands Nitrogen (b) and starting date of application before or equal reporting reference year"]
...
N3_node --- Y15((YES)) --- P4["If receiving area demands Other (c) and starting date of application before or equal reporting reference year"]
N3_node --- N17((NO)) --- P5["If receiving area demands Phosphorus (aP) and starting date of application before or equal reporting reference year"]

P4 --- P42["If receiving area demands Phosphorus (aP) and starting date of application before or equal reporting reference year"]
P4 --- P43["If receiving area demands Phosphorus (aP) and starting date of application before or equal reporting reference year"]

P42 --- Y16((YES)) --- NBO2["Required =  Phosphorus (aP+b) & Nitrogen(b) & Other (aP+b+c)"]
P42 --- N18((NO)) --- NBP2["Required = Nitrogen(b) & Other (b+c)"]

NBO2 -.- ID24(["01-B-24"])
NBP2 -.- ID23(["01-B-23"])

P43 --- Y17((YES)) --- NBO["Required = Nitrogen(b) & Phosphorus (aP+b)"]
P43 --- N19((NO)) --- NBP["Required = Nitrogen(b)"]

NBO -.- ID22(["01-B-22"])
NBP -.- ID21(["01-B-21"])

P5 --- Y18((YES)) --- P6["If receiving area demands Other (c) and starting date of application before or equal reporting reference year"]

P6 --- Y19((YES)) --- APO["Required = Phosphorus & Other (aP+c)"]
P6 --- N20((NO)) --- PREQ["Required = Phosphorus (aP)"]

APO -.- ID20(["01-B-20"])
PREQ -.- ID18(["01-B-18"])

P5 --- N21((NO)) --- O7["If receiving area demands Other (c) and starting date of application before or equal reporting reference year"]

O7 --- Y20((YES)) --- OREQ["Required = Other (c)"]
O7 --- N22((NO)) --- SEC4["Required = Secondary"]
...
class Y1,Y2,Y3,Y4,Y5,Y6,Y7,Y8,Y9,Y10,Y11,Y12,Y13,Y14,Y15,Y16,Y17,Y18,Y19,Y20 yesBox;
class N1,N2,N3,N4,N5,N6,N7,N8,N9,N10,N11,N12,N13,N14,N15,N16,N17,N18,N19,N20,N21,N22 noBox;
